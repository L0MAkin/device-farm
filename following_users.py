...
def run_tests_on_device(udid, appium_port, wda_port, device_name):
    ...
    user_tab.click()
    sleep(5)
    user_select_locator = (By.IOS_CLASS_CHAIN, f"**/XCUIElementTypeButton[`name CONTAINS 'skybribaby'`]")
